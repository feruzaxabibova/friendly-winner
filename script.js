...
for (const size of sizeList) {
  ...
  // razmerni textcontentiga berish
  ...
  newSizeSpan.style.cssText = `padding: 35px;
                                border-radius: 50%;`;
...
for (const mix of mixList) {
  ...
  // elementlarga class qoshib chiqish
  newMixSpan.style.fontSize = '20px';
  newMixSpan.style.marginLeft = '10px';
  newMixLabel.style.marginRight = '15px';
  newMixInput.style.transform = 'scale(2)';
...
for (const detail of detailsList) {
  ...
  // elementlarga class qoshib chiqish
  newDetailSpan.style.marginLeft = '15px';
  newDetailSpan.style.fontSize = '20px';
  newDetailLabel.classList.add("order__choose-detail-label");
  newDetailInput.style.transform = `scale(2)`;
